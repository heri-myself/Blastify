...
export default async function AdminCampaignsPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-foreground">History Broadcast</h1>
            ...
            {campaigns?.map((c) => {
              ...
              return (
                <tr key={c.id} className="hover:bg-background transition-colors">
                  ...
                  <td className="px-4 py-3 text-[13px] text-muted-foreground tabular-nums">{contactCount.toLocaleString()}</td>
                  ...
                  <td className="px-4 py-3 text-right">
                    <Link
                      ...
                      className="text-[13px] font-medium text-foreground hover:text-[#25D366] transition-colors"
                    >
                      Detail →
                    </Link>
                  </td>
