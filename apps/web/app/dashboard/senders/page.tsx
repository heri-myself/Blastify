            ...
            {senders?.map((sender) => (
              <tr key={sender.id} className="hover:bg-secondary/50 transition-colors">
                ...
                <td className="px-4 py-3">
                  ...
                  ) : (sender.session_data as any)?.reconnecting === true ? (
                    <span className="inline-flex items-center gap-1 text-[12px] font-medium text-blue-500">
                ...
                {!isSuperadmin && (
                  <td className="px-4 py-3">
                    <div className="flex gap-2 justify-end items-center">
                      ...
                      <DeleteSenderButton senderId={sender.id} phoneNumber={sender.phone_number} />
                    </div>
                  </td>
                )}
              </tr>
